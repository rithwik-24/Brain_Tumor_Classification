...
#     st.markdown("<h1 style='text-align:center;'>🌐 Federated Brain AI Portal</h1>", unsafe_allow_html=True)
#     c1, c2 = st.columns(2)
...
#     st.title("🌍 Global Model Server")

#     m1, m2 = st.columns(2)
#     m1.metric("Global Accuracy", f"{st.session_state.global_acc:.2f}%")
#     m2.metric("Predictions Received", "≥1" if st.session_state.has_prediction else "0")
...
#     st.markdown("<h1 style='text-align: center; margin-bottom: 50px;'>🌐 Federated Medical AI Portal</h1>", unsafe_allow_html=True)
#     col1, col2 = st.columns(2)
    
#     with col1:
#         st.markdown("<div class='glass-card'>", unsafe_allow_html=True)
#         st.subheader("🧠 Local Client Node")
...
#     with col2:
#         st.markdown("<div class='glass-card'>", unsafe_allow_html=True)
#         st.subheader("🌍 Global Federated Server")
#         st.write("**Network Status:** 🟢 Active")
...
#         if uploaded_file and st.button("🔍 Predict Tumor"):
...
#             if st.button("🔗 Push Updates to Global Server"):
...
#     st.title("🌍 Global Federated Server")
...
#     if st.button("🔄 Start Aggregation Round (FedAvg)"):
...
#     if st.button("📋 View Detailed Contribution History"):
...
#     if st.button("← Back to Global Server"):
#         st.session_state.page_selection = "Global"
#         st.rerun()
    
#     st.title("📋 Client Contribution Logs")
...
#     c1, c2 = st.columns(2)
#     with c1:
#         st.markdown("<div class='main-card'><h3>🧠 Local Client Node</h3><p>Perform private MRI analysis and generate Saliency Maps locally.</p></div>", unsafe_allow_html=True)
#         if st.button("Access Local Node"):
#             st.session_state.page = "Local"
#             st.rerun()
#     with c2:
#         st.markdown("<div class='main-card'><h3>🌍 Global Server</h3><p>Manage Federated Aggregation and Client Contribution Logs.</p></div>", unsafe_allow_html=True)
...
#     if st.button("← Back to Portal"): st.session_state.page = "Landing"; st.rerun()
    
#     st.title("🧠 Local Node Analysis")
...
#         if uploaded_file and st.button("🔍 Run Full Diagnostic"):
...
#             if st.button("🔗 Push Contribution to Global Server"):
#                 st.session_state.client_updates.append({
...
#     st.markdown("<div class='main-card'>", unsafe_allow_html=True)
#     if st.button("📋 View Contribution History"):
#         st.session_state.page = "History"
#         st.rerun()
        
#     if st.button("🔄 Execute Aggregation Round"):
...
#     if st.button("← Back to Server"): st.session_state.page = "Global"; st.rerun()
#     st.title("📋 Contribution History")
#     if st.session_state.client_updates:
#         st.table(st.session_state.client_updates)
#     else:
